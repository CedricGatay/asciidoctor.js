...
u;return this});e.$private();return(a.defn(e,"$anchor",function(a){return new RegExp("^"+a.toString().substr(1,a.toString().length-2))}),u)&&"anchor"}(a.base,null)};L.modules["asciidoctor/opal_ext/file"]=function(a){function u(a,c){return"number"===typeof a&&"number"===typeof c?a+c:a["$+"](c)}a.dynamic_require_severity="ignore";var n=a.nil,l=a.breaker,m=a.module,d=a.klass,e=a.gvars,c=a.range;a.add_stubs("$new $attr_reader $read $size $to_enum $chomp $each_line $* $rindex $[] $+ $- $nil_or_empty? $nil?".split(" "));
(function(b){b=m(b,"Kernel");var c=b.$$scope,d;a.defn(b,"$open",d=function(b){var e,f,p=d.$$p||n,D=n,D=arguments.length-1;0>D&&(D=0);for(var g=Array(D),H=0;H<D;H++)g[H]=arguments[H+1];d.$$p=null;D=(e=c.get("File")).$new.apply(e,[b].concat(a.to_a(g)));return p!==n?(f=a.yield1(p,D),f):D})})(a.base);(function(b,$super){function m(){}var E=m=d(b,$super,"File",m),z=E.$$proto,f=E.$$scope,p;z.eof=z.path=n;a.cdecl(f,"SEPARATOR","/");a.cdecl(f,"ALT_SEPARATOR",n);E.$attr_reader("eof");E.$attr_reader("lineno");
E.$attr_reader("path");a.defn(E,"$initialize",function(a,b){this.path=a;this.contents=n;this.eof=!1;return this.lineno=0});a.defn(E,"$read",function(){var a,b=n;return(a=this.eof)===n||a.$$is_boolean&&1!=a?(b=f.get("File").$read(this.path),this.eof=!0,this.lineno=b.$size(),b):""});a.defn(E,"$each_line",p=function(b){var g,c=p.$$p||n,d=n;null==e["/"]&&(e["/"]=n);null==b&&(b=e["/"]);p.$$p=null;if((g=this.eof)!==n&&(!g.$$is_boolean||1==g))return c!==n?this:[].$to_enum();if(c!==n){d=f.get("File").$read(this.path);
this.eof=!1;this.lineno=0;for(var w=d.$chomp(),d=d.length!=w.length,w=w.split(b),h=0,k=w.length;h<k;h++)this.lineno+=1,h<k-1||d?(g=a.yield1(c,w[h]+b))===l?l.$v:g:(g=a.yield1(c,w[h]))===l?l.$v:g;this.eof=!0;return this}return this.$read().$each_line()});a.defs(E,"$expand_path",function(a){return a});a.defs(E,"$join",function(){var a=arguments.length-0;0>a&&(a=0);for(var b=Array(a),c=0;c<a;c++)b[c]=arguments[c+0];a=f.get("SEPARATOR");return"number"===typeof b&&"number"===typeof a?b*a:b["$*"](a)});a.defs(E,
"$basename",function(a){var b,d=n;return(b=d=a.$rindex(f.get("SEPARATOR")))===n||b.$$is_boolean&&1!=b?a:a["$[]"](c(u(d,1),-1,!1))});a.defs(E,"$dirname",function(a){var b,d=n;return(b=d=a.$rindex(f.get("SEPARATOR")))===n||b.$$is_boolean&&1!=b?".":a["$[]"](c(0,"number"===typeof d?d-1:d["$-"](1),!1))});a.defs(E,"$extname",function(a){var b,d=n;if((b=a["$nil_or_empty?"]())!==n&&(!b.$$is_boolean||1==b))return"";d=a["$[]"](c(1,-1,!1)).$rindex(".");return(b=d["$nil?"]())===n||b.$$is_boolean&&1!=b?a["$[]"](c(u(d,
1),-1,!1)):""});a.defs(E,"$file?",function(a){return!0});a.defs(E,"$readable?",function(a){return!0});return(a.defs(E,"$read",function(a){var b="",c=-1;try{var d=new na;d.open("GET",a,!1);d.addEventListener("load",function(){c=this.status;if(0==c||200==c)b=this.responseText});d.overrideMimeType("text/plain");d.send()}catch(e){c=0}if(404==c||0==c&&""==b)throw f.get("IOError").$new("No such file or directory: "+a);return b}),n)&&"read"})(a.base,null);return function(b,$super){function c(){}var e=c=
d(b,$super,"IO",c),m=e.$$scope;return(a.defs(e,"$read",function(a){return m.get("File").$read(a)}),n)&&"read"}(a.base,null)};L.modules["asciidoctor/opal_ext/match_data"]=function(a){a.dynamic_require_severity="ignore";var u=a.nil,n=a.klass;a.add_stubs(["$[]="]);return function(l,$super){function d(){}var e=d=n(l,$super,"MatchData",d);e.$$proto.matches=u;return(a.defn(e,"$[]=",function(a,b){return this.matches["$[]="](a,b)}),u)&&"[]="}(a.base,null)};L.modules["asciidoctor/opal_ext/kernel"]=function(a){a.dynamic_require_severity=
"ignore";var u=a.nil,n=a.module;return function(l){l=n(l,"Kernel");a.defn(l,"$freeze",function(){return u})}(a.base)};L.modules["asciidoctor/opal_ext/nashorn/io"]=function(a){a.dynamic_require_severity="ignore";var u;u=a.nil;var n=a.gvars;null==n.stdout&&(n.stdout=u);null==n.stderr&&(n.stderr=u);a.add_stubs(["$write_proc="]);a=[function(a){print(a)}];u=n.stdout;u["$write_proc="].apply(u,a);a[a.length-1];return a=[function(a){print(a)}],u=n.stderr,u["$write_proc="].apply(u,a),a[a.length-1]};L.modules["asciidoctor/opal_ext"]=
...
a.module,u=u(a.base,"Asciidoctor").$$scope;a.cdecl(u,"VERSION","1.5.4")};L.modules["asciidoctor/timings"]=function(a){function u(a,b){return"number"===typeof a&&"number"===typeof b?a-b:a["$-"](b)}function n(a,b){return"number"===typeof a&&"number"===typeof b?a>b:a["$>"](b)}function l(a,b){return"number"===typeof a&&"number"===typeof b?a+b:a["$+"](b)}a.dynamic_require_severity="ignore";var m=a.nil,d=a.module,e=a.klass,c=a.hash2,b=a.gvars;a.add_stubs("$[]= $now $- $delete $> $+ $[] $puts $% $to_f $read_parse $convert $read_parse_convert".split(" "));
return function(B){(function(d,$super){function z(){}var f=z=e(d,$super,"Timings",z),p=f.$$proto;p.timers=p.log=m;a.defn(f,"$initialize",function(){this.log=c([],{});return this.timers=c([],{})});a.defn(f,"$start",function(b){return this.timers["$[]="](b,a.get("Time").$now())});a.defn(f,"$record",function(b){return this.log["$[]="](b,u(a.get("Time").$now(),this.timers.$delete(b)))});a.defn(f,"$read_parse",function(){var a,b=m;return n(b=l(!1!==(a=this.log["$[]"]("read"))&&a!==m?a:0,!1!==(a=this.log["$[]"]("parse"))&&
a!==m?a:0),0)?b:m});a.defn(f,"$convert",function(){var a;return!1!==(a=this.log["$[]"]("convert"))&&a!==m?a:0});a.defn(f,"$read_parse_convert",function(){var a,b=m;return n(b=l(l(!1!==(a=this.log["$[]"]("read"))&&a!==m?a:0,!1!==(a=this.log["$[]"]("parse"))&&a!==m?a:0),!1!==(a=this.log["$[]"]("convert"))&&a!==m?a:0),0)?b:m});a.defn(f,"$total",function(){var a,b=m;return n(b=l(l(l(!1!==(a=this.log["$[]"]("read"))&&a!==m?a:0,!1!==(a=this.log["$[]"]("parse"))&&a!==m?a:0),!1!==(a=this.log["$[]"]("convert"))&&
a!==m?a:0),!1!==(a=this.log["$[]"]("write"))&&a!==m?a:0),0)?b:m});return(a.defn(f,"$print_report",function(a,g){null==b.stdout&&(b.stdout=m);null==a&&(a=b.stdout);null==g&&(g=m);!1!==g&&g!==m&&a.$puts("Input file: "+g);a.$puts("  Time to read and parse source: "+"%05.5f"["$%"](this.$read_parse().$to_f()));a.$puts("  Time to convert document: "+"%05.5f"["$%"](this.$convert().$to_f()));return a.$puts("  Total time (read, parse and convert): "+"%05.5f"["$%"](this.$read_parse_convert().$to_f()))}),m)&&
"print_report"})(d(B,"Asciidoctor").$$scope.base,null)}(a.base)};L.modules["asciidoctor/core_ext/object/nil_or_empty"]=function(a){a.dynamic_require_severity="ignore";var u=a.nil,n=a.klass;a.add_stubs(["$respond_to?"]);(function(l,$super){function d(){}var e=d=n(l,$super,"NilClass",d),c;return(c=e["$respond_to?"]("nil_or_empty?"))===u||c.$$is_boolean&&1!=c?a.alias(e,"nil_or_empty?","nil?"):u})(a.base,null);(function(l,$super){function d(){}var e=d=n(l,$super,"String",d),c;return(c=e["$respond_to?"]("nil_or_empty?"))===
u||c.$$is_boolean&&1!=c?a.alias(e,"nil_or_empty?","empty?"):u})(a.base,null);(function(l,$super){function d(){}var e=d=n(l,$super,"Array",d),c;return(c=e["$respond_to?"]("nil_or_empty?"))===u||c.$$is_boolean&&1!=c?a.alias(e,"nil_or_empty?","empty?"):u})(a.base,null);(function(l,$super){function d(){}var e=d=n(l,$super,"Hash",d),c;return(c=e["$respond_to?"]("nil_or_empty?"))===u||c.$$is_boolean&&1!=c?a.alias(e,"nil_or_empty?","empty?"):u})(a.base,null);return function(l,$super){function d(){}var e=
d=n(l,$super,"Numeric",d),c;return(c=e["$respond_to?"]("nil_or_empty?"))===u||c.$$is_boolean&&1!=c?a.alias(e,"nil_or_empty?","nil?"):u}(a.base,null)};L.modules["asciidoctor/core_ext"]=function(a){a.dynamic_require_severity="ignore";var u=a.top,n=a.nil;a.add_stubs(["$require","$=="]);u.$require("asciidoctor/core_ext/object/nil_or_empty");if(a.get("RUBY_ENGINE")["$=="]("opal"))return n};L.modules["asciidoctor/helpers"]=function(a){a.dynamic_require_severity="ignore";var u=a.nil,n=a.module,l=a.range,
m=a.gvars;a.add_stubs("$require $== $=== $fail $warn $chomp $message $class $normalize_lines_from_string $normalize_lines_array $empty? $to_a $bytes $[] $map $rstrip $lines $encode $force_encoding $join $[]= $encoding $nil_or_empty? $each_line $include? $=~ $gsub $sprintf $each_byte $extname $-@ $length $basename $directory? $dirname $! $!= $mkdir_p $mkdir".split(" "));return function(d){(function(d){d=n(d,"Helpers");var c=d.$$scope;a.defs(d,"$require_library",function(b,c,d){var e=u,m=u;null==c&&
(c=!0);null==d&&(d="abort");try{return this.$require(b)}catch(f){if(a.rescue(f,[a.get("LoadError")])){e=f;try{if(!1!==c&&c!==u)return c["$=="](!0)&&(c=b),m=d,"abort"["$==="](m)?this.$fail("asciidoctor: FAILED: required gem '"+c+"' is not installed. Processing aborted."):"warn"["$==="](m)?this.$warn("asciidoctor: WARNING: optional gem '"+c+"' is not installed. Functionality disabled."):u;m=d;return"abort"["$==="](m)?this.$fail("asciidoctor: FAILED: "+e.$message().$chomp(".")+". Processing aborted."):
"warn"["$==="](m)?this.$warn("asciidoctor: WARNING: "+e.$message().$chomp(".")+". Functionality disabled."):u}finally{a.gvars["!"]=a.exceptions.pop()||a.nil}}else throw f;}});a.defs(d,"$normalize_lines",function(b){return b.$class()["$=="](a.get("String"))?this.$normalize_lines_from_string(b):this.$normalize_lines_array(b)});a.defs(d,"$normalize_lines_array",function(b){var d,e,m,n,f,p,D=u,g=u,H=u,J=u;if((d=b["$empty?"]())!==u&&(!d.$$is_boolean||1==d))return[];D=(g=b["$[]"](0))["$[]"](l(0,2,!1)).$bytes().$to_a();
if((d=c.get("COERCE_ENCODING"))===u||d.$$is_boolean&&1!=d){if(D["$=="](c.get("BOM_BYTES_UTF_8")))b["$[]="](0,g["$[]"](l(3,-1,!1)));return(d=b.$map,d.$$p=(p=function(a){null==a&&(a=u);return a.$rstrip()},p.$$s=this,p),d).call(b)}H=a.get("Encoding").$$scope.get("UTF_8");if((J=D["$[]"](l(0,1,!1)))["$=="](c.get("BOM_BYTES_UTF_16LE")))return(d=(e=b.$join().$force_encoding(a.get("Encoding").$$scope.get("UTF_16LE"))["$[]"](l(1,-1,!1)).$encode(H).$lines()).$map,d.$$p=(m=function(a){null==a&&(a=u);return a.$rstrip()},
m.$$s=this,m),d).call(e);if(J["$=="](c.get("BOM_BYTES_UTF_16BE")))return b["$[]="](0,g.$force_encoding(a.get("Encoding").$$scope.get("UTF_16BE"))["$[]"](l(1,-1,!1))),(d=b.$map,d.$$p=(n=function(b){null==b&&(b=u);return""+b.$force_encoding(a.get("Encoding").$$scope.get("UTF_16BE")).$encode(H).$rstrip()},n.$$s=this,n),d).call(b);if(D["$[]"](l(0,2,!1))["$=="](c.get("BOM_BYTES_UTF_8")))b["$[]="](0,g.$force_encoding(H)["$[]"](l(1,-1,!1)));return(d=b.$map,d.$$p=(f=function(a){null==a&&(a=u);return a.$encoding()["$=="](H)?
a.$rstrip():a.$force_encoding(H).$rstrip()},f.$$s=this,f),d).call(b)});a.defs(d,"$normalize_lines_from_string",function(b){var d,e,m,n=u,f=u,p=u;if((d=b["$nil_or_empty?"]())!==u&&(!d.$$is_boolean||1==d))return[];(d=c.get("COERCE_ENCODING"))===u||d.$$is_boolean&&1!=d?b["$[]"](l(0,2,!1)).$bytes().$to_a()["$=="](c.get("BOM_BYTES_UTF_8"))&&(b=b["$[]"](l(3,-1,!1))):(n=a.get("Encoding").$$scope.get("UTF_8"),f=b["$[]"](l(0,2,!1)).$bytes().$to_a(),(p=f["$[]"](l(0,1,!1)))["$=="](c.get("BOM_BYTES_UTF_16LE"))?
b=b.$force_encoding(a.get("Encoding").$$scope.get("UTF_16LE"))["$[]"](l(1,-1,!1)).$encode(n):p["$=="](c.get("BOM_BYTES_UTF_16BE"))?b=b.$force_encoding(a.get("Encoding").$$scope.get("UTF_16BE"))["$[]"](l(1,-1,!1)).$encode(n):f["$[]"](l(0,2,!1))["$=="](c.get("BOM_BYTES_UTF_8"))?b=b.$encoding()["$=="](n)?b["$[]"](l(1,-1,!1)):b.$force_encoding(n)["$[]"](l(1,-1,!1)):b.$encoding()["$=="](n)||(b=b.$force_encoding(n)));return(d=(e=b.$each_line()).$map,d.$$p=(m=function(a){null==a&&(a=u);return a.$rstrip()},
m.$$s=this,m),d).call(e)});a.defs(d,"$uriish?",function(a){var d;return d=a["$include?"](":"),!1!==d&&d!==u?a["$=~"](c.get("UriSniffRx")):d});a.defs(d,"$uri_prefix",function(a){var d,e;return(d=(e=a["$include?"](":"),!1!==e&&e!==u?a["$=~"](c.get("UriSniffRx")):e))===u||d.$$is_boolean&&1!=d?u:(d=m["~"])===u?u:d["$[]"](0)});a.cdecl(c,"REGEXP_ENCODE_URI_CHARS",/[^\w\-.!~*';:@=+$,()\[\]]/);a.defs(d,"$encode_uri",function(a){var d,e;return(d=a.$gsub,d.$$p=(e=function(){var a=e.$$s||this,b,c,d,D;return(b=
(c=((D=m["~"])===u?u:D["$[]"](0)).$each_byte()).$map,b.$$p=(d=function(a){var b=d.$$s||this;null==a&&(a=u);return b.$sprintf("%%%02X",a)},d.$$s=a,d),b).call(c).$join()},e.$$s=this,e),d).call(a,c.get("REGEXP_ENCODE_URI_CHARS"))});a.defs(d,"$rootname",function(b){var c,d=u;return(c=(d=a.get("File").$extname(b))["$empty?"]())===u||c.$$is_boolean&&1!=c?b["$[]"](l(0,d.$length()["$-@"](),!0)):b});a.defs(d,"$basename",function(b,c){var d;null==c&&(c=!1);return!1!==c&&c!==u?a.get("File").$basename(b,!1!==
(d=a.get("File").$extname(b))&&d!==u?d:""):a.get("File").$basename(b)});a.defs(d,"$mkdir_p",function(b){var c,d,e=u;return(c=a.get("File")["$directory?"](b))===u||c.$$is_boolean&&1!=c?(e=a.get("File").$dirname(b),(c=(d=a.get("File")["$directory?"](e=a.get("File").$dirname(b))["$!"](),!1!==d&&d!==u?e["$!="]("."):d))===u||c.$$is_boolean&&1!=c||this.$mkdir_p(e),a.get("Dir").$mkdir(b)):u})})(n(d,"Asciidoctor").$$scope.base)}(a.base)};L.modules["asciidoctor/substitutors"]=function(a){function u(a,b){return"number"===
...
y).call(r,p.get("AttributeReferenceRx")));return(y=!1!==(f=K)&&f!==d?f:!1!==x&&x!==d?h["$empty?"]():x)===d||y.$$is_boolean&&1!=y?C["$<<"](h):d},w.$$s=this,w),f).call(J);return!1!==h&&h!==d?n(C,p.get("EOL")):C});a.defn(f,"$sub_macros",function(b){var g,e,f,w,h,k,t,C,q,F,y,r,v,G,K,x,W,m,O,l,n=d,u=d,z=d,ea=d,N=d,Z=d;null==this.document&&(this.document=d);if((g=b["$nil_or_empty?"]())!==d&&(!g.$$is_boolean||1==g))return b;n=B([],{});n["$[]="]("square_bracket",b["$include?"]("["));n["$[]="]("round_bracket",
b["$include?"]("("));n["$[]="]("colon",u=b["$include?"](":"));n["$[]="]("macroish",(g=n["$[]"]("square_bracket"),!1!==g&&g!==d?u:g));n["$[]="]("macroish_short_form",(g=(e=n["$[]"]("square_bracket"),!1!==e&&e!==d?u:e),!1!==g&&g!==d?b["$include?"](":["):g));z=this.document.$attributes()["$has_key?"]("linkattrs");ea=this.document.$attributes()["$has_key?"]("experimental");N=""+b;!1!==ea&&ea!==d&&((g=(e=n["$[]"]("macroish_short_form"),!1!==e&&e!==d?!1!==(f=N["$include?"]("kbd:"))&&f!==d?f:N["$include?"]("btn:"):
e))===d||g.$$is_boolean&&1!=g||(N=(g=(e=N).$gsub,g.$$p=(w=function(){var a=w.$$s||this,k,h,b,c=d,t=d,c=c=d;null==A["~"]&&(A["~"]=d);c=A["~"];if((k=(t=c["$[]"](0))["$start_with?"]("\\"))!==d&&(!k.$$is_boolean||1==k))return t["$[]"](E(1,-1,!1));if((k=t["$start_with?"]("kbd"))===d||k.$$is_boolean&&1!=k){if((k=t["$start_with?"]("btn"))===d||k.$$is_boolean&&1!=k)return d;c=a.$unescape_bracketed_text(c["$[]"](1));return p.get("Inline").$new(a,"button",c).$convert()}c=a.$unescape_bracketed_text(c["$[]"](1));
c=c["$=="]("+")?["+"]:(k=(h=c.$split(p.get("KbdDelimiterRx"))).$inject,k.$$p=(b=function(a,k){var h;null==a&&(a=d);null==k&&(k=d);if((h=k["$end_with?"]("++"))===d||h.$$is_boolean&&1!=h)a["$<<"](k.$strip());else a["$<<"](k["$[]"](E(0,-3,!1)).$strip()),a["$<<"]("+");return a},b.$$s=a,b),k).call(h,[]);return p.get("Inline").$new(a,"kbd",d,B(["attributes"],{attributes:B(["keys"],{keys:c})})).$convert()},w.$$s=this,w),g).call(e,p.get("KbdBtnInlineMacroRx"))),(g=(f=n["$[]"]("macroish"),!1!==f&&f!==d?N["$include?"]("menu:"):
f))===d||g.$$is_boolean&&1!=g||(N=(g=(f=N).$gsub,g.$$p=(h=function(){var a=h.$$s||this,k,b,c,t=d,v=d,g=t=v=d,g=t=d;null==A["~"]&&(A["~"]=d);t=A["~"];if((k=(v=t["$[]"](0))["$start_with?"]("\\"))!==d&&(!k.$$is_boolean||1==k))return v["$[]"](E(1,-1,!1));v=t["$[]"](1);t=t["$[]"](2);(k=t["$!"]())===d||k.$$is_boolean&&1!=k?(k=g=(b=t["$include?"]("&gt;"))===d||b.$$is_boolean&&1!=b?(b=t["$include?"](","))===d||b.$$is_boolean&&1!=b?d:",":"&gt;")===d||k.$$is_boolean&&1!=k?(g=[],t=t.$rstrip()):(g=(k=(b=t.$split(g)).$map,
k.$$p=(c=function(a){null==a&&(a=d);return a.$strip()},c.$$s=a,c),k).call(b),t=g.$pop()):(g=[],t=d);return p.get("Inline").$new(a,"menu",d,B(["attributes"],{attributes:B(["menu","submenus","menuitem"],{menu:v,submenus:g,menuitem:t})})).$convert()},h.$$s=this,h),g).call(f,p.get("MenuInlineMacroRx"))),(g=(k=N["$include?"]('"'),!1!==k&&k!==d?N["$include?"]("&gt;"):k))===d||g.$$is_boolean&&1!=g||(N=(g=(k=N).$gsub,g.$$p=(t=function(){var k=t.$$s||this,h,b,v,g,r=d,y=d,e=y=r=r=d;null==A["~"]&&(A["~"]=d);
...
!1!==C&&C!==d?Z["$inline_macros?"]():C))===d||g.$$is_boolean&&1!=g||(g=(C=Z.$inline_macros()).$each,g.$$p=(q=function(a){var k=q.$$s||this,h,b,c;null==a&&(a=d);return N=(h=(b=N).$gsub,h.$$p=(c=function(){var k=c.$$s||this,h,b=d,t=d,b=d;null==A["~"]&&(A["~"]=d);b=A["~"];if((h=b["$[]"](0)["$start_with?"]("\\"))!==d&&(!h.$$is_boolean||1==h))return b["$[]"](0)["$[]"](E(1,-1,!1));t=b["$[]"](1);b=a.$config()["$[]"]("format")["$=="]("short")?B([],{}):a.$config()["$[]"]("content_model")["$=="]("attributes")?
k.$parse_attributes(b["$[]"](2),!1!==(h=a.$config()["$[]"]("pos_attrs"))&&h!==d?h:[],B(["sub_input","unescape_input"],{sub_input:!0,unescape_input:!0})):B(["text"],{text:k.$unescape_bracketed_text(b["$[]"](2))});return a.$process_method()["$[]"](k,t,b)},c.$$s=k,c),h).call(b,a.$instance().$regexp())},q.$$s=this,q),g).call(C);(g=(F=n["$[]"]("macroish"),!1!==F&&F!==d?!1!==(y=N["$include?"]("image:"))&&y!==d?y:N["$include?"]("icon:"):F))===d||g.$$is_boolean&&1!=g||(N=(g=(F=N).$gsub,g.$$p=(r=function(){var a=
...
h=v;!1!==(b=h["$[]"](k))&&b!==d?b:h["$[]="](k,p.get("Helpers").$basename(c,!0).$tr("_-"," "));return p.get("Inline").$new(a,"image",d,B(["type","target","attributes"],{type:t,target:c,attributes:v})).$convert()},r.$$s=this,r),g).call(F,p.get("ImageInlineMacroRx")));(g=!1!==(y=n["$[]"]("macroish_short_form"))&&y!==d?y:n["$[]"]("round_bracket"))===d||g.$$is_boolean&&1!=g||(N=(g=(y=N).$gsub,g.$$p=(v=function(){var k=v.$$s||this,h,b,c=d,t=d,g=d,r=d,c=c=d;null==k.document&&(k.document=d);null==A["~"]&&
...
1!=k?t:t.$sub(p.get("UriSniffRx"),""),!1!==r&&r!==d)r["$[]="]("role",("bare "+r["$[]"]("role")).$chomp(" "));else r=B(["role"],{role:"bare"});if(!1!==r&&r!==d)g["$[]="]("attributes",r);return p.get("Inline").$new(a,"anchor",c,g).$convert()},W.$$s=this,W),g).call(K,p.get("LinkInlineMacroRx")));(g=N["$include?"]("@"))===d||g.$$is_boolean&&1!=g||(N=(g=(x=N).$gsub,g.$$p=(m=function(){var a=m.$$s||this,k,h=d,b=d,h=h=d;null==a.document&&(a.document=d);null==A["~"]&&(A["~"]=d);h=A["~"];b=h["$[]"](0);if((k=
h=h["$[]"](1))!==d&&(!k.$$is_boolean||1==k))return"\\"["$==="](h)?b["$[]"](E(1,-1,!1)):b;h="mailto:"+b;a.document.$register("links",h);return p.get("Inline").$new(a,"anchor",b,B(["type","target"],{type:"link",target:h})).$convert()},m.$$s=this,m),g).call(x,p.get("EmailInlineMacroRx")));(g=(O=n["$[]"]("macroish_short_form"),!1!==O&&O!==d?N["$include?"]("footnote"):O))===d||g.$$is_boolean&&1!=g||(N=(g=(O=N).$gsub,g.$$p=(l=function(){var k=l.$$s||this,h,b,c,t,v=d,g=d,r=d,y=v=d,e=d,r=d;null==k.document&&
...
this.co_index)});return(a.defn(m,"$generate_callout_id",function(a,b){return"CO"+a+"-"+b}),l)&&"generate_callout_id"})(m(c,"Asciidoctor").$$scope.base,null)}(a.base)};L.modules["asciidoctor/converter/base"]=function(a){a.dynamic_require_severity="ignore";var u=a.nil,n=a.module,l=a.klass,m=a.hash2;a.add_stubs(["$include","$node_name","$empty?","$send","$content"]);return function(d){d=n(d,"Asciidoctor").$$scope;n(d.base,"Converter");u;(function(a,$super){function b(){}var d=b=l(a,$super,"Base",b);
return d.$include(d.$$scope.get("Converter"))})(d.get("Converter"),null);(function(e,$super){function b(){}var d=b=l(e,$super,"BuiltIn",b);a.defn(d,"$initialize",function(a,b){null==b&&m([],{});return u});a.defn(d,"$convert",function(a,b,e){var f;null==b&&(b=u);null==e&&(e=m([],{}));!1!==(f=b)&&f!==u?f:b=a.$node_name();return(f=e["$empty?"]())===u||f.$$is_boolean&&1!=f?this.$send(b,a,e):this.$send(b,a)});a.alias(d,"handles?","respond_to?");a.defn(d,"$content",function(a){return a.$content()});a.alias(d,
"pass","content");return(a.defn(d,"$skip",function(a){return u}),u)&&"skip"})(d.get("Converter"),null)}(a.base)};L.modules["asciidoctor/converter/factory"]=function(a){a.dynamic_require_severity="ignore";var u=a.nil,n=a.module,l=a.klass,m=a.hash2;a.add_stubs("$new $require $to_s $warn $register $default $resolve $create $converters $unregister_all $attr_reader $each $[]= $== $[] $clear $is_a? $=== $key?".split(" "));return function(d){(function(e){(function(c,$super){function e(){}var d=e=l(c,$super,
"Factory",e),n=d.$$proto,z=d.$$scope;n.converters=n.star_converter=u;d.__default__=u;(function(c){a.defn(c,"$default",function(c){var f,e;null==this.__default__&&(this.__default__=u);null==c&&(c=!0);if(!1===c||c===u)c=!1!==(f=this.__default__)&&f!==u?f:this.$new();else{if(!1===(f=this.__default__)||f===u){var d;a:{try{((e=null==a.Object.$$scope.ThreadSafe?u:"constant")===u||e.$$is_boolean&&1!=e)&&this.$require("thread_safe".$to_s());d=this.$new(a.get("ThreadSafe").$$scope.get("Cache").$new());break a}catch(m){if(a.rescue(m,
[a.get("LoadError")]))try{this.$warn("asciidoctor: WARNING: gem 'thread_safe' is not installed. This gem is recommended when registering custom converters.");d=this.$new();break a}finally{a.gvars["!"]=a.exceptions.pop()||a.nil}else throw m;}d=void 0}f=this.__default__=d}c=f}return c});a.defn(c,"$register",function(a,c){null==c&&(c=["*"]);return this.$default().$register(a,c)});a.defn(c,"$resolve",function(a){return this.$default().$resolve(a)});a.defn(c,"$create",function(a,c){null==c&&(c=m([],{}));
return this.$default().$create(a,c)});a.defn(c,"$converters",function(){return this.$default().$converters()});return(a.defn(c,"$unregister_all",function(){return this.$default().$unregister_all()}),u)&&"unregister_all"})(a.get_singleton_class(d));d.$attr_reader("converters");a.defn(d,"$initialize",function(a){var c;null==a&&(a=u);this.converters=!1!==(c=a)&&c!==u?c:m([],{});return this.star_converter=u});a.defn(d,"$register",function(a,c){var e,d,m;null==c&&(c=["*"]);(e=(d=c).$each,e.$$p=(m=function(c){var e=
m.$$s||this;null==e.converters&&(e.converters=u);null==c&&(c=u);e.converters["$[]="](c,a);return c["$=="]("*")?e.star_converter=a:u},m.$$s=this,m),e).call(d);return u});a.defn(d,"$resolve",function(a){var c,e;return c=this.converters,!1!==c&&c!==u?!1!==(e=this.converters["$[]"](a))&&e!==u?e:this.star_converter:c});a.defn(d,"$unregister_all",function(){this.converters.$clear();return this.star_converter=u});return(a.defn(d,"$create",function(c,e){var d,g=this,l=u,n=l=u,w=u;null==e&&(e=m([],{}));if((d=
l=g.$resolve(c))!==u&&(!d.$$is_boolean||1==d))return(d=l["$is_a?"](a.get("Class")))===u||d.$$is_boolean&&1!=d?l:l.$new(c,e);l=function(){n=c;if("html5"["$==="](n)){var k;try{k=null!=a.get("Asciidoctor").$$scope.get("Converter").$$scope.get("Html5Converter")?"constant":u}catch(h){if(h.$$class===a.NameError)k=u;else throw h;}((d=k)===u||d.$$is_boolean&&1!=d)&&g.$require("asciidoctor/converter/html5".$to_s());return z.get("Html5Converter").$new(c,e)}if("docbook5"["$==="](n)){var C;try{C=null!=a.get("Asciidoctor").$$scope.get("Converter").$$scope.get("DocBook5Converter")?
"constant":u}catch(h){if(h.$$class===a.NameError)C=u;else throw h;}((d=C)===u||d.$$is_boolean&&1!=d)&&g.$require("asciidoctor/converter/docbook5".$to_s());return z.get("DocBook5Converter").$new(c,e)}if("docbook45"["$==="](n)){var q;try{q=null!=a.get("Asciidoctor").$$scope.get("Converter").$$scope.get("DocBook45Converter")?"constant":u}catch(h){if(h.$$class===a.NameError)q=u;else throw h;}((d=q)===u||d.$$is_boolean&&1!=d)&&g.$require("asciidoctor/converter/docbook45".$to_s());return z.get("DocBook45Converter").$new(c,
e)}if("manpage"["$==="](n)){var m;try{m=null!=a.get("Asciidoctor").$$scope.get("Converter").$$scope.get("ManPageConverter")?"constant":u}catch(h){if(h.$$class===a.NameError)m=u;else throw h;}((d=m)===u||d.$$is_boolean&&1!=d)&&g.$require("asciidoctor/converter/manpage".$to_s());return z.get("ManPageConverter").$new(c,e)}return u}();if((d=e["$key?"]("template_dirs"))===u||d.$$is_boolean&&1!=d)return l;var h;try{h=null!=a.get("Asciidoctor").$$scope.get("Converter").$$scope.get("TemplateConverter")?"constant":
u}catch(t){if(t.$$class===a.NameError)h=u;else throw t;}((d=h)===u||d.$$is_boolean&&1!=d)&&g.$require("asciidoctor/converter/template".$to_s());var k;try{k=null!=a.get("Asciidoctor").$$scope.get("Converter").$$scope.get("CompositeConverter")?"constant":u}catch(t){if(t.$$class===a.NameError)k=u;else throw t;}((d=k)===u||d.$$is_boolean&&1!=d)&&g.$require("asciidoctor/converter/composite".$to_s());w=z.get("TemplateConverter").$new(c,e["$[]"]("template_dirs"),e);return z.get("CompositeConverter").$new(c,
w,l)}),u)&&"create"})(n(e,"Converter").$$scope.base,null)})(n(d,"Asciidoctor").$$scope.base)}(a.base)};L.modules["asciidoctor/converter"]=function(a){a.dynamic_require_severity="ignore";var u=a.top,n=a.nil,l=a.module,m=a.range,d=a.hash2;a.add_stubs("$register $== $send $include? $setup_backend_info $raise $class $sub $[] $[]= $backend_info $extend $include $respond_to? $write $chomp $open $require".split(" "));(function(e){e=l(e,"Asciidoctor").$$scope;(function(c){c=l(c,"Converter");var b=c.$$scope;
(function(b){b=l(b,"Config");var c=b.$$scope;a.defn(b,"$register_for",function(){var b,e,f,d,m,g=n,g=arguments.length-0;0>g&&(g=0);for(var l=Array(g),u=0;u<g;u++)l[u]=arguments[u+0];c.get("Factory").$register(this,l);g=function(a){return a}(a.get_singleton_class(this));l["$=="](["*"])?(b=(e=g).$send,b.$$p=(f=function(a){return!0},f.$$s=this,f),b).call(e,"define_method","converts?"):(b=(d=g).$send,b.$$p=(m=function(a){null==a&&(a=n);return l["$include?"](a)},m.$$s=this,m),b).call(d,"define_method",
...
e=this.backend.$sub(c.get("TrailingDigitsRx"),"");(b=f=c.get("DEFAULT_EXTENSIONS")["$[]"](e))===n||b.$$is_boolean&&1!=b?(e="html",f=".html",l=p="html"):p=f["$[]"](m(1,-1,!1));return d(["basebackend","outfilesuffix","filetype","htmlsyntax"],{basebackend:e,outfilesuffix:f,filetype:p,htmlsyntax:l})});a.defn(b,"$filetype",function(a){null==a&&(a=n);return!1!==a&&a!==n?this.$backend_info()["$[]="]("filetype",a):this.$backend_info()["$[]"]("filetype")});a.defn(b,"$basebackend",function(a){null==a&&(a=n);
return!1!==a&&a!==n?this.$backend_info()["$[]="]("basebackend",a):this.$backend_info()["$[]"]("basebackend")});a.defn(b,"$outfilesuffix",function(a){null==a&&(a=n);return!1!==a&&a!==n?this.$backend_info()["$[]="]("outfilesuffix",a):this.$backend_info()["$[]"]("outfilesuffix")});a.defn(b,"$htmlsyntax",function(a){null==a&&(a=n);return!1!==a&&a!==n?this.$backend_info()["$[]="]("htmlsyntax",a):this.$backend_info()["$[]"]("htmlsyntax")})})(b.base);(function(b){var c=b.$$scope;return(a.defn(b,"$included",
function(a){return a.$extend(c.get("Config"))}),n)&&"included"})(a.get_singleton_class(c));c.$include(b.get("Config"));c.$include(b.get("BackendInfo"));a.defn(c,"$initialize",function(a,b){null==b&&d([],{});this.backend=a;return this.$setup_backend_info()});a.defn(c,"$convert",function(b,c,e){null==e&&d([],{});return this.$raise(a.get("NotImplementedError"))});a.alias(c,"convert_with_options","convert")})(e.base);(function(c){c=l(c,"Writer");var b=c.$$scope;a.defn(c,"$write",function(c,e){var d,m,
f;(d=e["$respond_to?"]("write"))===n||d.$$is_boolean&&1!=d?(d=(m=a.get("File")).$open,d.$$p=(f=function(a){null==a&&(a=n);return a.$write(c)},f.$$s=this,f),d).call(m,e,"w"):(e.$write(c.$chomp()),e.$write(b.get("EOL")));return n})})(e.base);(function(c){c=l(c,"VoidWriter");c.$include(c.$$scope.get("Writer"));a.defn(c,"$write",function(a,c){return n})})(e.base)})(a.base);u.$require("asciidoctor/converter/base");return u.$require("asciidoctor/converter/factory")};L.modules["asciidoctor/converter/html5"]=
function(a){function u(a,b){return"number"===typeof a&&"number"===typeof b?a>=b:a["$>="](b)}function n(a,b){return"number"===typeof a&&"number"===typeof b?a*b:a["$*"](b)}function l(a,b){return"number"===typeof a&&"number"===typeof b?a>b:a["$>"](b)}function m(a,b){return"number"===typeof a&&"number"===typeof b?a<=b:a["$<="](b)}function d(a,b){return"number"===typeof a&&"number"===typeof b?a<b:a["$<"](b)}function e(a,b){return"number"===typeof a&&"number"===typeof b?a+b:a["$+"](b)}a.dynamic_require_severity=
...
c||e.$$is_boolean&&1!=e?c:"/";return this.stylesheets=J.get("Stylesheets").$instance()});a.defn(g,"$document",function(a){var b,e,d,f,g,y,r=c,v=c,G=c,K=c,x=c,m=c,T=c,O=m=T=m=T=K=T=K=T=c,v=v=m=m=T=c,r=[],v=this.void_element_slash,G="<br"+v+">";if((b=(K=a.$attr("asset-uri-scheme","https"))["$empty?"]())===c||b.$$is_boolean&&1!=b)K=""+K+":";x=""+K+"//cdnjs.cloudflare.com/ajax/libs";m=!1!==(b=u(a.$safe(),J.get("SafeMode").$$scope.get("SECURE")))&&b!==c?b:a["$attr?"]("linkcss");r["$<<"]("<!DOCTYPE html>");
...
a["$has_header?"]())!==c&&(!b.$$is_boolean||1==b)){if((b=a.$notitle())===c||b.$$is_boolean&&1!=b)r["$<<"]("<h1>"+a.$header().$title()+"</h1>");O=[];if((b=a["$attr?"]("author"))!==c&&(!b.$$is_boolean||1==b)){O["$<<"]('<span id="author" class="author">'+a.$attr("author")+"</span>"+G);if((b=a["$attr?"]("email"))!==c&&(!b.$$is_boolean||1==b))O["$<<"]('<span id="email" class="email">'+a.$sub_macros(a.$attr("email"))+"</span>"+G);l(T=a.$attr("authorcount").$to_i(),1)&&(b=(e=E(2,T,!1)).$each,b.$$p=(g=function(b){var k;
null==b&&(b=c);O["$<<"]('<span id="author'+b+'" class="author">'+a.$attr("author_"+b)+"</span>"+G);return(k=a["$attr?"]("email_"+b))===c||k.$$is_boolean&&1!=k?c:O["$<<"]('<span id="email'+b+'" class="email">'+a.$sub_macros(a.$attr("email_"+b))+"</span>"+G)},g.$$s=this,g),b).call(e)}if((b=a["$attr?"]("revnumber"))!==c&&(!b.$$is_boolean||1==b))O["$<<"]('<span id="revnumber">'+(!1!==(b=a.$attr("version-label"))&&b!==c?b:"").$downcase()+" "+a.$attr("revnumber")+((b=a["$attr?"]("revdate"))===c||b.$$is_boolean&&
1!=b?"":",")+"</span>");if((b=a["$attr?"]("revdate"))!==c&&(!b.$$is_boolean||1==b))O["$<<"]('<span id="revdate">'+a.$attr("revdate")+"</span>");if((b=a["$attr?"]("revremark"))!==c&&(!b.$$is_boolean||1==b))O["$<<"](""+G+'<span id="revremark">'+a.$attr("revremark")+"</span>");if((b=O["$empty?"]())===c||b.$$is_boolean&&1!=b)r["$<<"]('<div class="details">'),r.$concat(O),r["$<<"]("</div>")}if((b=(d=(f=!1!==m&&m!==c)?a["$attr?"]("toc"):m,!1!==d&&d!==c?a["$attr?"]("toc-placement","auto"):d))!==c&&(!b.$$is_boolean||
...
a.$id())===c||b.$$is_boolean&&1!=b?c:' id="'+a.$id()+'"',d=(b=a["$title?"]())===c||b.$$is_boolean&&1!=b?c:'<div class="title">'+a.$title()+"</div>\n";return"<div"+e+' class="'+((b=f=a.$role())===c||b.$$is_boolean&&1!=b?"sidebarblock":n(["sidebarblock",f]," "))+'">\n<div class="content">\n'+d+a.$content()+"\n</div>\n</div>"});a.defn(g,"$table",function(a){var b,e,d,f,g,y,r,v,G,K,x=c,m=c,T=c,O=c,u=c,w=O=T=u=c,z=c,x=[],m=(b=a.$id())===c||b.$$is_boolean&&1!=b?c:' id="'+a.$id()+'"',T=["tableblock","frame-"+
a.$attr("frame","all"),"grid-"+a.$attr("grid","all")],O=[];if((b=a["$option?"]("autowidth"))===c||b.$$is_boolean&&1!=b)if((u=a.$attr("tablepcwidth"))["$=="](100))T["$<<"]("spread");else O["$<<"]("width: "+u+"%;");if((b=u=a.$role())!==c&&(!b.$$is_boolean||1==b))T["$<<"](u);T=' class="'+n(T," ")+'"';if((b=a["$attr?"]("float"))!==c&&(!b.$$is_boolean||1==b))O["$<<"]("float: "+a.$attr("float")+";");O=(b=O["$empty?"]())===c||b.$$is_boolean&&1!=b?' style="'+n(O," ")+'"':c;x["$<<"]("<table"+m+T+O+">");if((b=
...
return"<div"+d+f+">"+g+'\n<pre class="content">'+a.$content()+"</pre>"+v+"\n</div>"});a.defn(g,"$video",function(b){var k,e,d=this,f=c,g=c,y=c,r=c,v=c,G=c,K=c,x=c,m=c,l=c,O=c,u=c,w=c,z=c,H=c,J=c,A=c,D=c,B=c,E=c,Q=c,ca=c,X=c,P=c,aa=c,I=c,R=c,L=c,ja=c,ka=c,V=c,f=b.$document()["$attr?"]("htmlsyntax","xml"),g=(k=b.$id())===c||k.$$is_boolean&&1!=k?c:' id="'+b.$id()+'"',y=["videoblock",b.$style(),b.$role()].$compact(),r=' class="'+n(y," ")+'"',v=(k=b["$title?"]())===c||k.$$is_boolean&&1!=k?c:'\n<div class="title">'+
b.$captioned_title()+"</div>",G=(k=b["$attr?"]("width"))===c||k.$$is_boolean&&1!=k?c:' width="'+b.$attr("width")+'"',K=(k=b["$attr?"]("height"))===c||k.$$is_boolean&&1!=k?c:' height="'+b.$attr("height")+'"';return function(){x=b.$attr("poster");if("vimeo"["$==="](x)){if((k=(m=b.$document().$attr("asset-uri-scheme","https"))["$empty?"]())===c||k.$$is_boolean&&1!=k)m=""+m+":";l=(k=b["$attr?"]("start",c,!1))===c||k.$$is_boolean&&1!=k?c:"#at="+b.$attr("start");O="?";u=(k=b["$option?"]("autoplay"))===
c||k.$$is_boolean&&1!=k?c:""+O+"autoplay=1";!1!==u&&u!==c&&(O="&amp;");w=(k=b["$option?"]("loop"))===c||k.$$is_boolean&&1!=k?c:""+O+"loop=1";return"<div"+g+r+">"+v+'\n<div class="content">\n<iframe'+G+K+' src="'+m+"//player.vimeo.com/video/"+b.$attr("target")+l+u+w+'" frameborder="0"'+((k=b["$option?"]("nofullscreen"))===c||k.$$is_boolean&&1!=k?d.$append_boolean_attribute("allowfullscreen",f):c)+"></iframe>\n</div>\n</div>"}if("youtube"["$==="](x)){if((k=(m=b.$document().$attr("asset-uri-scheme",
...
"");return y=""+y.$chop()+" "+b+'="'+a.$attr(b)+'px">'},d.$$s=this,d),e).call(f),!1!==y&&y!==c&&(g=g.$sub(J.get("SvgStartTagRx"),y)));return g}),c)&&"read_svg_contents"})(z.get("Converter"),z.get("Converter").$$scope.get("BuiltIn"))}(a.base)};L.modules["asciidoctor/document"]=function(a){function u(a,b){return"number"===typeof a&&"number"===typeof b?a>=b:a["$>="](b)}function n(a,b){return"number"===typeof a&&"number"===typeof b?a+b:a["$+"](b)}function l(a,b){return"number"===typeof a&&"number"===
...
p.$attr_reader("references");p.$attr_reader("counters");p.$attr_reader("callouts");p.$attr_reader("header");p.$attr_reader("base_dir");p.$attr_reader("options");p.$attr_reader("outfilesuffix");p.$attr_reader("parent_document");p.$attr_reader("reader");p.$attr_reader("converter");p.$attr_reader("extensions");a.defn(p,"$initialize",H=function(c,e){var f,d,q,l,y,r,v,G,K,x,W,p,O=m,w=m,J=m,U=m,M=U=m,D=m,A=O=D=U=O=U=U=m;null==c&&(c=m);null==e&&(e=b([],{}));H.$$p=null;a.find_super_dispatcher(this,"initialize",
H,null).apply(this,[this,"document"]);if((f=O=e.$delete("parent"))===m||f.$$is_boolean&&1!=f){this.parent_document=m;this.references=b("ids footnotes links images indexterms includes".split(" "),{ids:b([],{}),footnotes:[],links:[],images:[],indexterms:[],includes:a.get("Set").$new()});this.callouts=g.get("Callouts").$new();w=b([],{});(f=(d=!1!==(v=e["$[]"]("attributes"))&&v!==m?v:b([],{})).$each,f.$$p=(r=function(a,b){var c;null==a&&(a=m);null==b&&(b=m);(c=a["$start_with?"]("!"))===m||c.$$is_boolean&&
1!=c?(c=a["$end_with?"]("!"))===m||c.$$is_boolean&&1!=c||(a=a.$chop(),b=m):(a=a["$[]"](B(1,-1,!1)),b=m);return w["$[]="](a.$downcase(),b)},r.$$s=this,r),f).call(d);this.attribute_overrides=w;if((f=(U=e["$[]"]("safe"))["$!"]())===m||f.$$is_boolean&&1!=f)if((f=a.get("Fixnum")["$==="](U))===m||f.$$is_boolean&&1!=f)try{this.safe=g.get("SafeMode").$const_get(U.$to_s().$upcase())}catch(Z){try{this.safe=g.get("SafeMode").$$scope.get("SECURE")}finally{a.gvars["!"]=a.exceptions.pop()||a.nil}}else this.safe=
U;else this.safe=g.get("SafeMode").$$scope.get("SECURE");this.sourcemap=e["$[]"]("sourcemap");this.compat_mode=!1;this.converter=m;try{J=null!=a.get("Asciidoctor").$$scope.get("Extensions")?"constant":m}catch(Z){if(Z.$$class===a.NameError)J=m;else throw Z;}this.extensions=m}else this.parent_document=O,f="base_dir",d=e,!1!==(q=d["$[]"](f))&&q!==m?q:d["$[]="](f,O.$base_dir()),this.references=(f=(d=O.$references()).$inject,f.$$p=(l=function(a,b){null==a&&(a=m);var c=b[0],e=b[1];if(c["$=="]("footnotes"))a["$[]="]("footnotes",
...
1!=f)w["$[]="]("linkcss","");f="icons";G=w;!1!==(x=G["$[]"](f))&&x!==m?x:G["$[]="](f,m)}}(f=(G=w).$delete_if,f.$$p=(W=function(b,c){var e,f,k=m;null==b&&(b=m);null==c&&(c=m);k=!1;(e=c["$nil?"]())===m||e.$$is_boolean&&1!=e?((e=(f=a.get("String")["$==="](c),!1!==f&&f!==m?c["$end_with?"]("@"):f))===m||e.$$is_boolean&&1!=e||(c=c.$chop(),k=!0),M["$[]="](b,c)):M.$delete(b);return k},W.$$s=this,W),f).call(G);(f=M["$key?"]("compat-mode"))===m||f.$$is_boolean&&1!=f||(this.compat_mode=!0);if(!1!==O&&O!==m)return f=
"doctype",x=M,!1!==(p=x["$[]"](f))&&p!==m?p:x["$[]="](f,g.get("DEFAULT_DOCTYPE")),this.reader=g.get("Reader").$new(c,e["$[]"]("cursor")),g.get("Parser").$parse(this.reader,this),this.$restore_attributes(),this.parsed=!0;if((f="backend",x=M,!1!==(p=x["$[]"](f))&&p!==m?p:x["$[]="](f,g.get("DEFAULT_BACKEND")))["$=="]("manpage"))M["$[]="]("doctype",w["$[]="]("doctype","manpage"));else f="doctype",x=M,!1!==(p=x["$[]"](f))&&p!==m?p:x["$[]="](f,g.get("DEFAULT_DOCTYPE"));this.$update_backend_attributes(M["$[]"]("backend"),
...
oa=b,pa=q=I=I=ha=Y=q=I=ha=b,ia=V=S=q=Y=q=q=b,na=b,sa=b,ta=V=S=S=b,ra=B=b,ua=b;null==f&&(f=z([],{}));null==g&&(g=z([],{}));B=c.$skip_blank_lines();if((h=c["$has_more_lines?"]())===b||h.$$is_boolean&&1!=h)return b;(h=(x=E=g["$[]"]("text"),!1!==x&&x!==b?n(B,0):x))===b||h.$$is_boolean&&1!=h||(g.$delete("text"),E=!1);ba=g.$fetch("parse_metadata",!0);Q=e.$document();(h=ca=Q.$extensions())===b||h.$$is_boolean&&1!=h?X=P=!1:(X=ca["$blocks?"](),P=ca["$block_macros?"]());aa=k.get("ListItem")["$==="](e);L=R=
I=b;ja=Q.$sourcemap();for(ka=b;(x=(l=I["$!"](),!1!==l&&l!==b?c["$has_more_lines?"]():l))!==b&&(!x.$$is_boolean||1==x);)if((x=(l=!1!==ba&&ba!==b)?this.$parse_block_metadata_line(c,Q,f,g):ba)===b||x.$$is_boolean&&1!=x){!1!==ja&&ja!==b&&(ka=c.$cursor());V=c.$read_line();q=!1;ga=ma=S=b;(x=f["$[]"](1))===b||x.$$is_boolean&&1!=x||(x=a.to_ary(this.$parse_style_attribute(f,c)),R=null==x[0]?b:x[0],L=null==x[1]?b:x[1]);(x=Y=this["$is_delimited_block?"](V,!0))===b||x.$$is_boolean&&1!=x||((q=!0,S=ma=Y.$context(),
...
[],z(["sub_result","into"],{sub_result:!1,into:f}));break}else if((l=(t=(q=!1!==P&&P!==b)?da=k.get("GenericBlockMacroRx").$match(V):P,!1!==t&&t!==b?la=ca["$registered_for_block_macro?"](da["$[]"](1)):t))!==b&&(!l.$$is_boolean||1==l)){q=da["$[]"](2);I=da["$[]"](3);if(la.$config()["$[]"]("content_model")["$=="]("attributes"))((l=I["$empty?"]())===b||l.$$is_boolean&&1!=l)&&Q.$parse_attributes(I,!1!==(l=la.$config()["$[]"]("pos_attrs"))&&l!==b?l:[],z(["sub_input","sub_result","into"],{sub_input:!0,sub_result:!1,
into:f}));else f["$[]="]("text",I);(l=I=la.$config()["$[]"]("default_attrs"))===b||l.$$is_boolean&&1!=l||(l=(t=I).$each,l.$$p=(w=function(a,c){var e,d,k;null==a&&(a=b);null==c&&(c=b);return e=a,d=f,!1!==(k=d["$[]"](e))&&k!==b?k:d["$[]="](e,c)},w.$$s=this,w),l).call(t);if((l=I=la.$process_method()["$[]"](e,q,f.$dup()))===b||l.$$is_boolean&&1!=l)return f.$clear(),b;f.$replace(I.$attributes());break}if((l=da=k.get("CalloutListRx").$match(V))!==b&&(!l.$$is_boolean||1==l)){I=k.get("List").$new(e,"colist");
f["$[]="]("style","arabic");c.$unshift_line(V);for(Y=1;(q=!1!==(C=da)&&C!==b?C:(F=c["$has_more_lines?"](),!1!==F&&F!==b?da=k.get("CalloutListRx").$match(c.$peek_line()):F))!==b&&(!q.$$is_boolean||1==q);){(q=da["$[]"](1).$to_i()["$!="](Y))===b||q.$$is_boolean&&1!=q||this.$warn("asciidoctor: WARNING: "+c.$path()+": line "+d(c.$lineno(),2)+": callout list item index: expected "+Y+" got "+da["$[]"](1));ha=this.$next_list_item(c,I,da);Y=u(Y,1);if(!1!==ha&&ha!==b)if(I["$<<"](ha),qa=Q.$callouts().$callout_ids(I.$items().$size()),
(q=qa["$empty?"]()["$!"]())===b||q.$$is_boolean&&1!=q)this.$warn("asciidoctor: WARNING: "+c.$path()+": line "+d(c.$lineno(),2)+": no callouts refer to list item "+I.$items().$size());else ha.$attributes()["$[]="]("coids",qa);da=b}Q.$callouts().$next_list();break}else if((l=k.get("UnorderedListRx")["$=~"](V))!==b&&(!l.$$is_boolean||1==l)){c.$unshift_line(V);I=this.$next_outline_list(c,"ulist",e);break}else if((l=da=k.get("OrderedListRx").$match(V))!==b&&(!l.$$is_boolean||1==l)){c.$unshift_line(V);
I=this.$next_outline_list(c,"olist",e);if((l=(q=f["$[]"]("style")["$!"](),!1!==q&&q!==b?I.$attributes()["$[]"]("style")["$!"]():q))!==b&&(!l.$$is_boolean||1==l))if(oa=I.$items()["$[]"](0).$marker(),(l=oa["$start_with?"]("."))===b||l.$$is_boolean&&1!=l)R=(l=(q=k.get("ORDERED_LIST_STYLES")).$detect,l.$$p=(D=function(a){null==a&&(a=b);return k.get("OrderedListMarkerRxMap")["$[]"](a)["$=~"](oa)},D.$$s=this,D),l).call(q),f["$[]="]("style",(!1!==(l=R)&&l!==b?l:k.get("ORDERED_LIST_STYLES")["$[]"](0)).$to_s());
else f["$[]="]("style",(!1!==(l=k.get("ORDERED_LIST_STYLES")["$[]"](d(oa.$length(),1)))&&l!==b?l:k.get("ORDERED_LIST_STYLES")["$[]"](0)).$to_s());break}else if((l=da=k.get("DefinitionListRx").$match(V))!==b&&(!l.$$is_boolean||1==l)){c.$unshift_line(V);I=this.$next_labeled_list(c,da,e);break}else if((l=(C=!1!==(F=R["$=="]("float"))&&F!==b?F:R["$=="]("discrete"),!1!==C&&C!==b?this["$is_section_title?"](V,(F=k.get("Compliance").$underline_style_section_titles())===b||F.$$is_boolean&&1!=F?b:c.$peek_line(!0)):
C))!==b&&(!l.$$is_boolean||1==l)){c.$unshift_line(V);l=a.to_ary(this.$parse_section_title(c,Q));ha=null==l[0]?b:l[0];I=null==l[1]?b:l[1];q=null==l[2]?b:l[2];Y=null==l[3]?b:l[3];if(!1!==I&&I!==b)f["$[]="]("reftext",I);(l=f["$has_key?"]("id"))===b||l.$$is_boolean&&1!=l||(!1!==(l=ha)&&l!==b?l:ha=f["$[]"]("id"));I=k.get("Block").$new(e,"floating_title",z(["content_model"],{content_model:"empty"}));(l=ha["$nil_or_empty?"]())===b||l.$$is_boolean&&1!=l?l=[ha]:(ha=k.get("Section").$new(e),l=[q],C=ha,C["$title="].apply(C,
...
break}if((x=(l=I["$!"](),!1!==l&&l!==b?S:l))!==b&&(!x.$$is_boolean||1==x))if((x=!1!==(l=S["$=="]("abstract"))&&l!==b?l:S["$=="]("partintro"))===b||x.$$is_boolean&&1!=x||(S="open"),q=S,"admonition"["$==="](q))f["$[]="]("name",q=R.$downcase()),x="caption",l=f,!1!==(F=l["$[]"](x))&&F!==b?F:l["$[]="](x,Q.$attributes()["$[]"](""+q+"-caption")),I=this.$build_block(S,"compound",ga,e,c,f);else{if("comment"["$==="](q))return this.$build_block(S,"skip",ga,e,c,f),b;if("example"["$==="](q))I=this.$build_block(S,
"compound",ga,e,c,f);else if("listing"["$==="](q)||"fenced_code"["$==="](q)||"source"["$==="](q)){if(S["$=="]("fenced_code")){R=f["$[]="]("style","source");x=a.to_ary(V["$[]"](p(3,-1,!1)).$tr(" ","").$split(",",2));S=null==x[0]?b:x[0];V=null==x[1]?b:x[1];if((x=S["$nil_or_empty?"]()["$!"]())!==b&&(!x.$$is_boolean||1==x)){if(f["$[]="]("language",S),(x=V["$nil_or_empty?"]())===b||x.$$is_boolean&&1!=x)f["$[]="]("linenums","")}else if((x=ia=Q.$attributes()["$[]"]("source-language"))!==b&&(!x.$$is_boolean||
1==x))f["$[]="]("language",ia);if((x=(l=f["$key?"]("indent")["$!"](),!1!==l&&l!==b?Q.$attributes()["$key?"]("source-indent"):l))!==b&&(!x.$$is_boolean||1==x))f["$[]="]("indent",Q.$attributes()["$[]"]("source-indent"));ga=ga["$[]"](p(0,2,!1))}else if(S["$=="]("source")){k.get("AttributeList").$rekey(f,[b,"language","linenums"]);if(((x=f["$key?"]("language"))===b||x.$$is_boolean&&1!=x)&&(x=ia=Q.$attributes()["$[]"]("source-language"))!==b&&(!x.$$is_boolean||1==x))f["$[]="]("language",ia);if((x=(l=f["$key?"]("indent")["$!"](),
!1!==l&&l!==b?Q.$attributes()["$key?"]("source-indent"):l))!==b&&(!x.$$is_boolean||1==x))f["$[]="]("indent",Q.$attributes()["$[]"]("source-indent"))}I=this.$build_block("listing","verbatim",ga,e,c,f)}else if("literal"["$==="](q))I=this.$build_block(S,"verbatim",ga,e,c,f);else if("pass"["$==="](q))I=this.$build_block(S,"raw",ga,e,c,f);else if("stem"["$==="](q)||"latexmath"["$==="](q)||"asciimath"["$==="](q)){if(S["$=="]("stem"))f["$[]="]("style",(x=na=f["$[]"](2))===b||x.$$is_boolean&&1!=x?(x=(sa=
Q.$attributes()["$[]"]("stem"))["$nil_or_empty?"]())===b||x.$$is_boolean&&1!=x?sa:"asciimath":(x=na["$include?"]("tex"))===b||x.$$is_boolean&&1!=x?"asciimath":"latexmath");I=this.$build_block("stem","raw",ga,e,c,f)}else if("open"["$==="](q)||"sidebar"["$==="](q))I=this.$build_block(S,"compound",ga,e,c,f);else if("table"["$==="](q)){S=c.$cursor();S=k.get("Reader").$new(c.$read_lines_until(z(["terminator","skip_line_comments"],{terminator:ga,skip_line_comments:!0})),S);q=ga.$chr();if(","["$==="](q))f["$[]="]("format",
"csv");else if(":"["$==="](q))f["$[]="]("format","dsv");I=this.$next_table(S,e,f)}else if("quote"["$==="](q)||"verse"["$==="](q))k.get("AttributeList").$rekey(f,[b,"attribution","citetitle"]),I=this.$build_block(S,S["$=="]("verse")?"verbatim":"compound",ga,e,c,f);else if((x=(l=!1!==X&&X!==b)?la=ca["$registered_for_block?"](S,ma):X)===b||x.$$is_boolean&&1!=x)this.$raise("Unsupported block type "+S+" at "+c.$line_info());else if((x=(V=la.$config()["$[]"]("content_model"))["$!="]("skip"))===b||x.$$is_boolean&&
1!=x||((x=(ta=!1!==(l=la.$config()["$[]"]("pos_attrs"))&&l!==b?l:[])["$empty?"]()["$!"]())===b||x.$$is_boolean&&1!=x||k.get("AttributeList").$rekey(f,[b].$concat(ta)),(x=I=la.$config()["$[]"]("default_attrs"))===b||x.$$is_boolean&&1!=x||(x=(l=I).$each,x.$$p=(H=function(a,c){var e,d,k;null==a&&(a=b);null==c&&(c=b);return e=a,d=f,!1!==(k=d["$[]"](e))&&k!==b?k:d["$[]="](e,c)},H.$$s=this,H),x).call(l)),I=this.$build_block(S,V,ga,e,c,f,z(["extension"],{extension:la})),(x=(F=!1!==I&&I!==b)?V["$!="]("skip"):
I)===b||x.$$is_boolean&&1!=x)return f.$clear(),b}}else c.$advance();if(!1!==I&&I!==b){!1!==ka&&ka!==b&&(h=[ka],x=I,x["$source_location="].apply(x,h),h[h.length-1]);if((h=I["$title?"]())===b||h.$$is_boolean&&1!=h)h=[f["$[]"]("title")],x=I,x["$title="].apply(x,h),h[h.length-1];if(I.$context()["$=="]("image")){if(B=f["$[]"]("target"),I.$document().$register("images",B),h="alt",x=f,!1!==(F=x["$[]"](h))&&F!==b?F:x["$[]="](h,k.get("Helpers").$basename(B,!0).$tr("_-"," ")),f["$[]="]("alt",I.$sub_specialchars(f["$[]"]("alt"))),
I.$assign_caption(f.$delete("caption"),"figure"),!((h=ra=f["$[]"]("scaledwidth"))===b||h.$$is_boolean&&1!=h||(h=p(48,57,!1)["$include?"]((!1!==(x=ra["$[]"](-1))&&x!==b?x:0).$ord()))===b||h.$$is_boolean&&1!=h))f["$[]="]("scaledwidth",""+ra+"%")}else h=I,!1!==(x=h.$caption())&&x!==b?x:h["$caption="](f.$delete("caption"));h=[f["$[]"]("style")];x=I;x["$style="].apply(x,h);h[h.length-1];(h=ua=(x=I,!1!==(F=x.$id())&&F!==b?F:x["$id="](f["$[]"]("id"))))===b||h.$$is_boolean&&1!=h||Q.$register("ids",[ua,!1!==
...
B||B===b))A["$[]="](-1,"");if(P["$=="](k.get("LIST_CONTINUATION"))){(g=H["$!="]("frozen"))===b||g.$$is_boolean&&1!=g||(H="frozen",A["$<<"](P));P=b;continue}}if((g=l=this["$is_delimited_block?"](P,!0))===b||g.$$is_boolean&&1!=g)if((g=(h=(l=c["$=="]("dlist"))?H["$!="]("active"):c["$=="]("dlist"),!1!==h&&h!==b?k.get("BlockAttributeLineRx")["$=~"](P):h))===b||g.$$is_boolean&&1!=g)if((g=(h=H["$=="]("active"))?P["$empty?"]()["$!"]():H["$=="]("active"))===b||g.$$is_boolean&&1!=g)if((g=(l=aa["$nil?"]()["$!"](),
...
b||g.$$is_boolean&&1!=g||(a.$skip_blank_lines(),P=a.$read_line(),(g=!1!==(l=P["$nil?"]())&&l!==b?l:this["$is_sibling_list_item?"](P,c,e))===b||g.$$is_boolean&&1!=g)))break;if(P["$=="](k.get("LIST_CONTINUATION")))E=A.$size(),A["$<<"](P);else if(!1!==f&&f!==b)if((g=this["$is_sibling_list_item?"](P,c,e))===b||g.$$is_boolean&&1!=g)if((g=aa=(l=(p=k.get("NESTABLE_LIST_CONTEXTS")).$detect,l.$$p=(n=function(a){null==a&&(a=b);return k.get("ListRxMap")["$[]"](a)["$=~"](P)},n.$$s=this,n),l).call(p))===b||g.$$is_boolean&&
...
function(e){var f,g=b;null==e&&(e=b);g=k["$[]"](a["$[]"](p(e,e,!1)));return(f=c(u(e,1),a.$length())?n(k["$[]"](a["$[]"](p(u(e,1),u(e,1),!1))),g):c(u(e,1),a.$length()))===b||f.$$is_boolean&&1!=f?h=u(h,g):h=d(h,g)},g.$$s=this,g),e).call(f);return h}),b)&&"roman_numeral_to_int"})(A(g,"Asciidoctor").$$scope.base,null)}(a.base)};L.modules["asciidoctor/path_resolver"]=function(a){function u(a,b){return"number"===typeof a&&"number"===typeof b?a*b:a["$*"](b)}a.dynamic_require_severity="ignore";var n=a.nil,
l=a.module,m=a.klass,d=a.hash2,e=a.range;a.add_stubs("$attr_accessor $is_root? $expand_path $pwd $start_with? $== $=~ $nil_or_empty? $include? $tr $partition_path $join_path $[] $posixfy $is_web_root? $is_unc? $index $split $shift $delete $[]= $* $raise $empty? $system_path $!= $! $dup $each $> $length $pop $fetch $warn $push $uri_prefix $<< $+ $chomp".split(" "));return function(c){(function(b,$super){function c(){}var l=c=m(b,$super,"PathResolver",c),z=l.$$proto,f=l.$$scope;z.file_separator=z._partition_path_web=
z._partition_path_sys=z.working_dir=n;a.cdecl(f,"DOT",".");a.cdecl(f,"DOT_DOT","..");a.cdecl(f,"DOT_SLASH","./");a.cdecl(f,"SLASH","/");a.cdecl(f,"BACKSLASH","\\");a.cdecl(f,"DOUBLE_SLASH","//");a.cdecl(f,"WindowsRootRx",/^[a-zA-Z]:(?:\\|\/)/);l.$attr_accessor("file_separator");l.$attr_accessor("working_dir");a.defn(l,"$initialize",function(b,c){var e;null==b&&(b=n);null==c&&(c=n);this.file_separator=!1!==b&&b!==n?b:!1!==(e=a.get("File").$$scope.get("ALT_SEPARATOR"))&&e!==n?e:a.get("File").$$scope.get("SEPARATOR");
this.working_dir=!1!==c&&c!==n?(e=this["$is_root?"](c))===n||e.$$is_boolean&&1!=e?a.get("File").$expand_path(c):c:a.get("File").$expand_path(a.get("Dir").$pwd());this._partition_path_sys=d([],{});return this._partition_path_web=d([],{})});a.defn(l,"$is_root?",function(b){var c,e,d;return(c=b["$start_with?"](f.get("SLASH")))===n||c.$$is_boolean&&1!=c?(c=this.file_separator["$=="](f.get("BACKSLASH"))?f.get("WindowsRootRx")["$=~"](b):this.file_separator["$=="](f.get("BACKSLASH")))===n||c.$$is_boolean&&
...
1!=b?a:a.$tr(f.get("BACKSLASH"),f.get("SLASH")):""});a.defn(l,"$expand_path",function(b){var c=n,e=n;b=a.to_ary(this.$partition_path(b));c=null==b[0]?n:b[0];e=null==b[1]?n:b[1];return this.$join_path(c,e)});a.defn(l,"$partition_path",function(a,b){var c,d=n,l=d=n,m=n;null==b&&(b=!1);if((c=d=!1!==b&&b!==n?this._partition_path_web["$[]"](a):this._partition_path_sys["$[]"](a))!==n&&(!c.$$is_boolean||1==c))return d;d=this.$posixfy(a);l=!1!==b&&b!==n?(c=this["$is_web_root?"](d))===n||c.$$is_boolean&&1!=
c?(c=d["$start_with?"](f.get("DOT_SLASH")))===n||c.$$is_boolean&&1!=c?n:f.get("DOT_SLASH"):f.get("SLASH"):(c=this["$is_root?"](d))===n||c.$$is_boolean&&1!=c?(c=d["$start_with?"](f.get("DOT_SLASH")))===n||c.$$is_boolean&&1!=c?n:f.get("DOT_SLASH"):(c=this["$is_unc?"](d))===n||c.$$is_boolean&&1!=c?(c=d["$start_with?"](f.get("SLASH")))===n||c.$$is_boolean&&1!=c?d["$[]"](e(0,d.$index(f.get("SLASH")),!1)):f.get("SLASH"):f.get("DOUBLE_SLASH");m=d.$split(f.get("SLASH"));l["$=="](f.get("DOUBLE_SLASH"))?m=
m["$[]"](e(2,-1,!1)):!1!==l&&l!==n&&m.$shift();m.$delete(f.get("DOT"));return(!1!==b&&b!==n?this._partition_path_web:this._partition_path_sys)["$[]="](a,[m,l,d])});a.defn(l,"$join_path",function(a,b){null==b&&(b=n);return!1!==b&&b!==n?""+b+u(a,f.get("SLASH")):u(a,f.get("SLASH"))});a.defn(l,"$system_path",function(b,c,e,l){var m,w,h,k=n,t=n,C=n,q=n,F=n,y=F=C=n,r=n;null==e&&(e=n);null==l&&(l=d([],{}));!1!==e&&e!==n&&(((m=this["$is_root?"](e))===n||m.$$is_boolean&&1!=m)&&this.$raise(a.get("SecurityError"),
"Jail is not an absolute path: "+e),e=this.$posixfy(e));(m=b["$nil_or_empty?"]())===n||m.$$is_boolean&&1!=m?(m=a.to_ary(this.$partition_path(b)),k=null==m[0]?n:m[0],t=null==m[1]?n:m[1]):k=[];if((m=k["$empty?"]())!==n&&(!m.$$is_boolean||1==m))if((m=c["$nil_or_empty?"]())===n||m.$$is_boolean&&1!=m){if((m=this["$is_root?"](c))===n||m.$$is_boolean&&1!=m)return this.$system_path(c,e,e,l);if(!1===e||e===n)return this.$expand_path(c)}else return!1!==e&&e!==n?e:this.working_dir;if(!((m=(w=!1!==t&&t!==n)?
t["$!="](f.get("DOT_SLASH")):t)===n||m.$$is_boolean&&1!=m||(C=this.$join_path(k,t),(m=!1!==(w=e["$!"]())&&w!==n?w:C["$start_with?"](e))===n||m.$$is_boolean&&1!=m)))return C;c=(m=c["$nil_or_empty?"]())===n||m.$$is_boolean&&1!=m?(m=this["$is_root?"](c))===n||m.$$is_boolean&&1!=m?this.$system_path(c,e,e,l):this.$posixfy(c):!1!==e&&e!==n?e:this.working_dir;e["$=="](c)?(m=a.to_ary(this.$partition_path(e)),q=null==m[0]?n:m[0],F=null==m[1]?n:m[1],C=q.$dup()):(!1!==e&&e!==n?(((m=c["$start_with?"](e))===n||
m.$$is_boolean&&1!=m)&&this.$raise(a.get("SecurityError"),""+(!1!==(m=l["$[]"]("target_name"))&&m!==n?m:"Start path")+" "+c+" is outside of jail: "+e+" (disallowed in safe mode)"),m=a.to_ary(this.$partition_path(c)),C=null==m[0]?n:m[0],F=null==m[1]?n:m[1],m=a.to_ary(this.$partition_path(e)),q=null==m[0]?n:m[0]):(m=a.to_ary(this.$partition_path(c)),C=null==m[0]?n:m[0]),F=null==m[1]?n:m[1]);y=C.$dup();r=!1;(m=(w=k).$each,m.$$p=(h=function(c){var d=h.$$s||this,k;null==c&&(c=n);if(c["$=="](f.get("DOT_DOT"))){if(!1!==
e&&e!==n){c=y.$length();var m=q.$length();if("number"===typeof c&&"number"===typeof m?c>m:c["$>"](m))return y.$pop();if((k=(!1!==n&&n!==n?n:l.$fetch("recover",!0))["$!"]())===n||k.$$is_boolean&&1!=k){if((k=r["$!"]())===n||k.$$is_boolean&&1!=k)return n;d.$warn("asciidoctor: WARNING: "+(!1!==(k=l["$[]"]("target_name"))&&k!==n?k:"path")+" has illegal reference to ancestor of jail, auto-recovering");return r=!0}return d.$raise(a.get("SecurityError"),""+(!1!==(k=l["$[]"]("target_name"))&&k!==n?k:"path")+
" "+b+" refers to location outside jail: "+e+" (disallowed in safe mode)")}return y.$pop()}return y.$push(c)},h.$$s=this,h),m).call(w);return this.$join_path(y,F)});a.defn(l,"$web_path",function(b,c){var d,l,m,w=n,h=n,k=n,t=n;null==c&&(c=n);b=this.$posixfy(b);c=this.$posixfy(c);w=n;if((d=!1!==(l=c["$nil_or_empty?"]())&&l!==n?l:this["$is_web_root?"](b))===n||d.$$is_boolean&&1!=d)b=""+c+f.get("SLASH")+b,(d=w=f.get("Helpers").$uri_prefix(b))===n||d.$$is_boolean&&1!=d||(b=b["$[]"](e(w.$length(),-1,!1)));
d=a.to_ary(this.$partition_path(b,!0));h=null==d[0]?n:d[0];k=null==d[1]?n:d[1];t=[];(d=(l=h).$each,d.$$p=(m=function(a){var b;null==a&&(a=n);return a["$=="](f.get("DOT_DOT"))?(b=t["$empty?"]())===n||b.$$is_boolean&&1!=b?t["$[]"](-1)["$=="](f.get("DOT_DOT"))?t["$<<"](a):t.$pop():(b=!1!==k&&k!==n?k["$!="](f.get("DOT_SLASH")):k)===n||b.$$is_boolean&&1!=b?t["$<<"](a):n:t["$<<"](a)},m.$$s=this,m),d).call(l);return!1!==w&&w!==n?""+w+this.$join_path(t,k):this.$join_path(t,k)});return(a.defn(l,"$relative_path",
function(a,b){var c,f,d=n;if((c=(f=this["$is_root?"](a),!1!==f&&f!==n?this["$is_root?"](b):f))===n||c.$$is_boolean&&1!=c)return a;c=b.$chomp(this.file_separator).$length();d="number"===typeof c?c+1:c["$+"](1);return a["$[]"](e(d,-1,!1))}),n)&&"relative_path"})(l(c,"Asciidoctor").$$scope.base,null)}(a.base)};L.modules["asciidoctor/reader"]=function(a){function u(a,b){return"number"===typeof a&&"number"===typeof b?a+b:a["$+"](b)}function n(a,b){return"number"===typeof a&&"number"===typeof b?a>b:a["$>"](b)}
function l(a,b){return"number"===typeof a&&"number"===typeof b?a*b:a["$*"](b)}function m(a,b){return"number"===typeof a&&"number"===typeof b?a-b:a["$-"](b)}function d(a,b){return"number"===typeof a&&"number"===typeof b?a>=b:a["$>="](b)}a.dynamic_require_severity="ignore";var e=a.nil,c=a.breaker,b=a.slice,B=a.module,A=a.klass,E=a.hash2,z=a.range;a.add_stubs("$attr_accessor $path $lineno $attr_reader $! $is_a? $split $file $dir $dirname $== $basename $prepare_lines $dup $empty? $[] $normalize_lines_from_string $normalize_lines_array $+ $nil? $peek_line $nil_or_empty? $> $process_line $times $read_line $<< $reverse_each $unshift $has_more_lines? $shift $* $read_lines $advance $eof? $start_with? $match $push $read_lines_until $=~ $size $clear $[]= $- $new $line_info $to_i $fetch $attributes $< $references $has_key? $skip_front_matter! $pop $adjust_indentation! $attr $end_with? $include? $preprocess_conditional_inclusion $captures $preprocess_include $strip $pop_include $downcase $warn $=== $detect $resolve_expr_val $send $to_sym $replace_next_line $rstrip $sub_attributes $attribute_missing $include_processors? $find $handles? $instance $process_method $parse $>= $safe $pwd $base_dir $join $uriish? $require_library $normalize_system_path $file? $relative_path $each $map $to_proc $/ $concat $to_a $uniq $sort $to_set $open $each_line $infinite? $push_include $force_encoding $chomp $read $extname $rootname $<= $!= $to_f $extensions? $extensions $include_processors $class $object_id $inspect $to_s".split(" "));
...
"eof?");a.defn(d,"$read_lines_until",h=function(b){var d,f,g,l,p,r=h.$$p||e,v=e,n=e,u=e,x=e,z=e,A=e,B=e,H=e,J=e,U=e;null==b&&(b=E([],{}));h.$$p=null;v=[];(d=b["$[]"]("skip_first_line"))===e||d.$$is_boolean&&1!=d||this.$advance();(d=(f=this.process_lines,!1!==f&&f!==e?b["$[]"]("skip_processing"):f))===e||d.$$is_boolean&&1!=d?n=!1:(this.process_lines=!1,n=!0);(d=u=b["$[]"]("terminator"))===e||d.$$is_boolean&&1!=d?(x=b["$[]"]("break_on_blank_lines"),z=b["$[]"]("break_on_list_continuation")):z=x=!1;A=
b["$[]"]("skip_line_comments");for(J=H=B=!1;(f=(g=J["$!"](),!1!==g&&g!==e?U=this.$read_line():g))!==e&&(!f.$$is_boolean||1==f);)if(J=function(){for(;(g=!0)!==e&&(!g.$$is_boolean||1==g);)return((g=(l=!1!==u&&u!==e)?U["$=="](u):u)===e||g.$$is_boolean&&1!=g)&&((g=(l=!1!==x&&x!==e)?U["$empty?"]():x)===e||g.$$is_boolean&&1!=g)?(g=(l=(p=!1!==z&&z!==e)?B:z,!1!==l&&l!==e?U["$=="](w.get("LIST_CONTINUATION")):l))===e||g.$$is_boolean&&1!=g?(g=(l=r!==e)?(p=a.yield1(r,U))===c?c.$v:p:r!==e)===e||g.$$is_boolean&&
...
k.$$p=(p=function(a){null==a&&(a=e);return a.$instance()["$handles?"](H)},p.$$s=this,p),k).call(t):h))===e||g.$$is_boolean&&1!=g){if(d(this.document.$safe(),w.get("SafeMode").$$scope.get("SECURE")))return this.$replace_next_line("link:"+H+"[]"),!0;if((g=(h=n(U=this.maxdepth["$[]"]("abs"),0))?d(this.include_stack.$size(),U):n(U=this.maxdepth["$[]"]("abs"),0))===e||g.$$is_boolean&&1!=g){if(n(U,0)){if((g=a.get("RUBY_ENGINE_OPAL"))===e||g.$$is_boolean&&1!=g)if((g=w.get("Helpers")["$uriish?"](H))===e||
...
B.get("AbstractBlock"))}(a.base)};L.modules["asciidoctor/stylesheets"]=function(a){a.dynamic_require_severity="ignore";var u=a.nil,n=a.module,l=a.klass,m=a.hash2;a.add_stubs("$join $new $chomp $read $primary_stylesheet_data $open $write $primary_stylesheet_name $coderay_stylesheet_data $coderay_stylesheet_name $load_pygments $pygments_stylesheet_data $pygments_stylesheet_name $! $nil? $require_library".split(" "));return function(d){(function(d,$super){function b(){}var n=b=l(d,$super,"Stylesheets",
...
function(a){var b;return(b=this.$load_pygments())===u||b.$$is_boolean&&1!=b?"/* Pygments styles disabled. Pygments is not available. */":!1!==(b=this.pygments_stylesheet_data)&&b!==u?b:this.pygments_stylesheet_data=m([],{})});a.defn(n,"$embed_pygments_stylesheet",function(a){null==a&&(a=u);return"<style>\n"+this.$pygments_stylesheet_data(a)+"\n</style>"});a.defn(n,"$write_pygments_stylesheet",function(b,f){var d,e,g;null==f&&(f=u);return(d=(e=a.get("File")).$open,d.$$p=(g=function(a){var b=g.$$s||
this;null==a&&(a=u);return a.$write(b.$pygments_stylesheet_data(f))},g.$$s=this,g),d).call(e,a.get("File").$join(b,this.$pygments_stylesheet_name(f)),"w")});return(a.defn(n,"$load_pygments",function(){var b;return(b=null==a.Object.$$scope.Pygments?u:"constant")===u||b.$$is_boolean&&1!=b?E.get("Helpers").$require_library("pygments","pygments.rb","ignore")["$nil?"]()["$!"]():!0}),u)&&"load_pygments"})(n(d,"Asciidoctor").$$scope.base,null)}(a.base)};L.modules["asciidoctor/table"]=function(a){function u(a,
b){return"number"===typeof a&&"number"===typeof b?a>b:a["$>"](b)}function n(a,b){return"number"===typeof a&&"number"===typeof b?a*b:a["$*"](b)}function l(a,b){return"number"===typeof a&&"number"===typeof b?a/b:a["$/"](b)}function m(a,b){return"number"===typeof a&&"number"===typeof b?a+b:a["$+"](b)}function d(a,b){return"number"===typeof a&&"number"===typeof b?a-b:a["$-"](b)}a.dynamic_require_severity="ignore";var e=a.nil,c=a.slice,b=a.module,B=a.klass,A=a.hash2,E=a.range;a.add_stubs("$attr_accessor $new $key? $[] $abs $to_i $== $!= $> $[]= $attributes $round $* $/ $to_f $empty? $body $each $+ $<< $size $assign_col_widths $** $assign_width $- $shift $style= $head= $foot= $pop $update_attributes $parent $attr_reader $delete $! $header_row? $table $split $include? $readlines $unshift $nil? $strip $apply_normal_subs $convert $map $text $to_s $cursor $raise $nested? $document $escape $columns $start_with? $match $chop $pre_match $post_match $end_with? $lstrip $push_cell_spec $cell_open? $close_cell $advance $take_cell_spec $fetch $warn $line_info $tr_s $upto $times $rowspan $activate_rowspan $colspan $end_of_row? $close_row $rows $effective_col_visits".split(" "));
...
return d.$require("asciidoctor/table")})(L);(function(a){a.dynamic_require_severity="ignore";return a.nil})(L);require("./asciidoctor-docbook.min.js")(L);ia&&require("./asciidoctor-extensions.min.js")(L);return L.Asciidoctor}}};
